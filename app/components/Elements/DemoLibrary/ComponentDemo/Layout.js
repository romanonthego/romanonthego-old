...
export default class DemoLayout extends PureComponent {
  ...
  render() {
    ...
    const demo = (
      <div
        style={this.getTagretStyle()}
        className="react-demo__target-wrap"
        key="demo"
      >
        {targetEl}
      </div>
    ...
    const panel = (
      <div
        style={this.getControlsStyle()}
        className="react-demo__controls-wrap"
        key="panel"
      >
        {controlsEl}
      </div>
    ...
    return (
      <div style={this.getWrapStyle()} className="react-demo">
        {[panel, demo]}
      </div>
    )
  }
